...
qwerty.func @withCtrl[]() irrev-> !qwerty<bitbundle[2]> {
  ...
  %1 = qwerty.qbtrans %0 by {list:{<UniformVectorSuperpos [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<VectorTilt tilt 2.700000e+02 : f64 [#qwerty.vectree<OneVector []>]>]>}, std:Z[1]} >> {list:{<UniformVectorSuperpos [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<VectorTilt tilt 2.700000e+02 : f64 [#qwerty.vectree<OneVector []>]>]>}, std:X[1]} : (!qwerty<qbundle[2]>) -> !qwerty<qbundle[2]>
...
//  CHECK-NEXT:   return %2 : !qcirc<array<i1>[2]>
//  CHECK-NEXT: }
// The 180-degree const tilt on the output |j> vector is the attribute-resident
// (const-phase) encoding of the pi that used to arrive as a phases() operand.
// It must lower to the same Z gate (P(pi) after peephole) as before.
qwerty.func @withCtrlPhase[]() irrev-> !qwerty<bitbundle[2]> {
  %0 = qwerty.qbprep Z<PLUS>[2] : () -> !qwerty<qbundle[2]>
  %1 = qwerty.qbtrans %0 by {list:{<UniformVectorSuperpos [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<VectorTilt tilt 2.700000e+02 : f64 [#qwerty.vectree<OneVector []>]>]>}, std:Z[1]} >> {list:{<VectorTilt tilt 1.800000e+02 : f64 [#qwerty.vectree<UniformVectorSuperpos [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<VectorTilt tilt 2.700000e+02 : f64 [#qwerty.vectree<OneVector []>]>]>]>}, std:X[1]} : (!qwerty<qbundle[2]>) -> !qwerty<qbundle[2]>
  %2 = qwerty.qbmeas %1 by {std:Z[2]} : !qwerty<qbundle[2]> -> !qwerty<bitbundle[2]>
  qwerty.return %2 : !qwerty<bitbundle[2]>
}
...
//  CHECK-NEXT:   return %2 : !qcirc<array<i1>[2]>
//  CHECK-NEXT: }
// Same const-phase encoding as @withCtrlPhase, but with a permuted veclist on
// the second qubit to exercise the alignment machinery alongside the residual.
qwerty.func @withCtrlXPhase[]() irrev-> !qwerty<bitbundle[2]> {
  %0 = qwerty.qbprep Z<PLUS>[2] : () -> !qwerty<qbundle[2]>
  %1 = qwerty.qbtrans %0 by {list:{<UniformVectorSuperpos [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<VectorTilt tilt 2.700000e+02 : f64 [#qwerty.vectree<OneVector []>]>]>}, list:{<OneVector []>, <ZeroVector []>}} >> {list:{<VectorTilt tilt 1.800000e+02 : f64 [#qwerty.vectree<UniformVectorSuperpos [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<VectorTilt tilt 2.700000e+02 : f64 [#qwerty.vectree<OneVector []>]>]>]>}, std:X[1]} : (!qwerty<qbundle[2]>) -> !qwerty<qbundle[2]>
  %2 = qwerty.qbmeas %1 by {std:Z[2]} : !qwerty<qbundle[2]> -> !qwerty<bitbundle[2]>
  qwerty.return %2 : !qwerty<bitbundle[2]>
}
...
qwerty.func @swap[]() irrev-> !qwerty<bitbundle[2]> {
  %0 = qwerty.qbprep Z<PLUS>[2] : () -> !qwerty<qbundle[2]>
  %1 = qwerty.qbtrans %0 by {list:{<VectorTensor [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<OneVector []>]>, <VectorTensor [#qwerty.vectree<OneVector []>, #qwerty.vectree<ZeroVector []>]>}} >> {list:{<VectorTensor [#qwerty.vectree<OneVector []>, #qwerty.vectree<ZeroVector []>]>, <VectorTensor [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<OneVector []>]>}} : (!qwerty<qbundle[2]>) -> !qwerty<qbundle[2]>
  %2 = qwerty.qbmeas %1 by {std:Z[2]} : !qwerty<qbundle[2]> -> !qwerty<bitbundle[2]>
  qwerty.return %2 : !qwerty<bitbundle[2]>
}
...
qwerty.func @cnot[]() irrev-> !qwerty<bitbundle[2]> {
  ...
  %5 = qwerty.qbtrans %4 by {list:{<VectorTensor [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>]>, <VectorTensor [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<OneVector []>]>, <VectorTensor [#qwerty.vectree<OneVector []>, #qwerty.vectree<ZeroVector []>]>, <VectorTensor [#qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>]>}} >> {list:{<VectorTensor [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>]>, <VectorTensor [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<OneVector []>]>, <VectorTensor [#qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>]>, <VectorTensor [#qwerty.vectree<OneVector []>, #qwerty.vectree<ZeroVector []>]>}} : (!qwerty<qbundle[2]>) -> !qwerty<qbundle[2]>
...
qwerty.func @small_perm[]() irrev-> !qwerty<bitbundle[2]> {
  %0 = qwerty.qbprep Z<PLUS>[2] : () -> !qwerty<qbundle[2]>
  %1 = qwerty.qbtrans %0 by {list:{<VectorTensor [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>]>, <VectorTensor [#qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>]>}} >> {list:{<VectorTensor [#qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>]>, <VectorTensor [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>]>}} : (!qwerty<qbundle[2]>) -> !qwerty<qbundle[2]>
  %2 = qwerty.qbmeas %1 by {std: Z[2]} : !qwerty<qbundle[2]> -> !qwerty<bitbundle[2]>
  qwerty.return %2 : !qwerty<bitbundle[2]>
}
...
qwerty.func @big_perm[]() irrev-> !qwerty<bitbundle[11]> {
  ...
  %1 = qwerty.qbtrans %0 by {list:{<VectorTensor [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>]>, <VectorTensor [#qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>]>}} >> {list:{<VectorTensor [#qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>]>, <VectorTensor [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>]>}} : (!qwerty<qbundle[11]>) -> !qwerty<qbundle[11]>
...
qwerty.func @really_big_perm[]() irrev-> !qwerty<bitbundle[128]> {
  ...
  %1 = qwerty.qbtrans %0 by {list:{<VectorTensor [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>]>, <VectorTensor [#qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>]>}} >> {list:{<VectorTensor [#qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>]>, <VectorTensor [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>]>}} : (!qwerty<qbundle[128]>) -> !qwerty<qbundle[128]>
...
qwerty.func @big_perm_multi_mask[]() irrev-> !qwerty<bitbundle[11]> {
  %0 = qwerty.qbprep Z<PLUS>[11] : () -> !qwerty<qbundle[11]>
  %1 = qwerty.qbtrans %0 by {list:{<VectorTensor [#qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>]>, <VectorTensor [#qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>]>, <VectorTensor [#qwerty.vectree<OneVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>]>, <VectorTensor [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>]>}} >> {list:{<VectorTensor [#qwerty.vectree<OneVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>]>, <VectorTensor [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>]>, <VectorTensor [#qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>]>, <VectorTensor [#qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>]>}} : (!qwerty<qbundle[11]>) -> !qwerty<qbundle[11]>
  %2 = qwerty.qbmeas %1 by {std: Z[11]} : !qwerty<qbundle[11]> -> !qwerty<bitbundle[11]>
  qwerty.return %2 : !qwerty<bitbundle[11]>
}
...
// Constant-phased revolve: the pi/7.2 (25-degree) phase arrives as a
// qcirc.calc constant operand and is folded into a const tilt at the
// revolve decomposition seam, so this lowers fully (same gates as
// pre-migration; only the position of the constant block moved).
