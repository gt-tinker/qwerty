...
//  CHECK-NEXT:   %3 = qwerty.qbtrans %2 by {list:{<VectorTensor [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>]>}, std: Z[2]} >> {list:{<VectorTensor [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>]>}, std: X[2]} : (!qwerty<qbundle[5]>) -> !qwerty<qbundle[5]>
...
qwerty.func @main[]() irrev -> !qwerty<bitbundle[2]> {
  %0 = qwerty.qbprep Z<PLUS>[5] : () -> !qwerty<qbundle[5]>
  %1 = qwerty.call pred {list:{<VectorTensor [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>, #qwerty.vectree<ZeroVector []>]>}} @h (%0) : (!qwerty<qbundle[5]>) -> !qwerty<qbundle[5]>
  %2 = qwerty.qbmeas %1 by {std:Z[5]} : !qwerty<qbundle[5]> -> !qwerty<bitbundle[5]>
  qwerty.return %2 : !qwerty<bitbundle[5]>
}
...
//  CHECK-NEXT:   %3 = qwerty.qbtrans %2 by {list:{<VectorTensor [#qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>]>}, std: Z[2]} >> {list:{<VectorTensor [#qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>]>}, std: X[2]} : (!qwerty<qbundle[5]>) -> !qwerty<qbundle[5]>
//  CHECK-NEXT:   %4:5 = qwerty.qbunpack %3 : (!qwerty<qbundle[5]>) -> (!qcirc.qubit, !qcirc.qubit, !qcirc.qubit, !qcirc.qubit, !qcirc.qubit)
...
qwerty.func @main[]() irrev -> !qwerty<bitbundle[2]> {
  %0 = qwerty.qbprep Z<PLUS>[5] : () -> !qwerty<qbundle[5]>
  %1 = qwerty.call pred {list:{<VectorTensor [#qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>]>}} @h (%0) : (!qwerty<qbundle[5]>) -> !qwerty<qbundle[5]>
  %2 = qwerty.qbmeas %1 by {std:Z[5]} : !qwerty<qbundle[5]> -> !qwerty<bitbundle[5]>
  qwerty.return %2 : !qwerty<bitbundle[5]>
}
