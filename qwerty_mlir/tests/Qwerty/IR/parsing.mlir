...
//  CHECK-NEXT:   %0 = qwerty.qbinit %arg0 as {list:{<VectorTensor [#qwerty.vectree<UniformVectorSuperpos [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<OneVector []>]>, #qwerty.vectree<UniformVectorSuperpos [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<VectorTilt tilt 1.800000e+02 : f64 [#qwerty.vectree<OneVector []>]>]>]>}, list:{<VectorTilt tilt theta [#qwerty.vectree<VectorTensor [#qwerty.vectree<UniformVectorSuperpos [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<VectorTilt tilt 2.700000e+02 : f64 [#qwerty.vectree<OneVector []>]>]>, #qwerty.vectree<UniformVectorSuperpos [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<VectorTilt tilt 9.000000e+01 : f64 [#qwerty.vectree<OneVector []>]>]>]>]>}} phases (%arg1) : (f64, !qwerty<qbundle[4]>) -> !qwerty<qbundle[4]>
//  CHECK-NEXT:   %1 = qwerty.qbdeinit %0 as {list:{<VectorTensor [#qwerty.vectree<UniformVectorSuperpos [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<OneVector []>]>, #qwerty.vectree<UniformVectorSuperpos [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<VectorTilt tilt 1.800000e+02 : f64 [#qwerty.vectree<OneVector []>]>]>]>}, list:{<VectorTilt tilt theta [#qwerty.vectree<VectorTensor [#qwerty.vectree<UniformVectorSuperpos [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<VectorTilt tilt 2.700000e+02 : f64 [#qwerty.vectree<OneVector []>]>]>, #qwerty.vectree<UniformVectorSuperpos [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<VectorTilt tilt 9.000000e+01 : f64 [#qwerty.vectree<OneVector []>]>]>]>]>}} phases (%arg1) : (f64, !qwerty<qbundle[4]>) -> !qwerty<qbundle[4]>
//  CHECK-NEXT:   qwerty.return %1 : !qwerty<qbundle[4]>
//  CHECK-NEXT: }
...
//  CHECK-NEXT:   %predBundleOut, %regionResult = qwerty.pred on {list:{<VectorTensor [#qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>]>}, std: X[2]} (%arg0: !qwerty<qbundle[5]>, %arg1 as %arg2: !qwerty<qbundle[4]>) -> (!qwerty<qbundle[5]>, !qwerty<qbundle[4]>) {
...
qwerty.func @pred_inlined[](%arg0: !qwerty<qbundle[5]>, %arg1: !qwerty<qbundle[4]>) irrev-> (!qwerty<qbundle[5]>, !qwerty<qbundle[4]>) {
  %predBundleOut, %regionResult = qwerty.pred on {list:{<VectorTensor [#qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>, #qwerty.vectree<OneVector []>]>}, std: X[2]} (%arg0: !qwerty<qbundle[5]>, %arg1 as %arg2: !qwerty<qbundle[4]>) -> (!qwerty<qbundle[5]>, !qwerty<qbundle[4]>) {
