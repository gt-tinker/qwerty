...
//  CHECK-NEXT:   %0 = qwerty.func_pred %arg0 by {list:{<UniformVectorSuperpos [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<VectorTilt tilt 2.700000e+02 : f64 [#qwerty.vectree<OneVector []>]>]>}, list:{<OneVector []>}} : (!qwerty<func(!qwerty<qbundle[2]>) rev-> !qwerty<qbundle[2]>>) -> !qwerty<func(!qwerty<qbundle[4]>) rev-> !qwerty<qbundle[4]>>
...
qwerty.func @return_pred_pred[](%arg0: !qwerty<func(!qwerty<qbundle[2]>) rev-> !qwerty<qbundle[2]>>) irrev-> !qwerty<func(!qwerty<qbundle[4]>) rev-> !qwerty<qbundle[4]>> {
  %0 = qwerty.func_pred %arg0 by {list:{<OneVector []>}} : (!qwerty<func(!qwerty<qbundle[2]>) rev-> !qwerty<qbundle[2]>>) -> !qwerty<func(!qwerty<qbundle[3]>) rev-> !qwerty<qbundle[3]>>
  %1 = qwerty.func_pred %0 by {list:{<UniformVectorSuperpos [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<VectorTilt tilt 2.700000e+02 : f64 [#qwerty.vectree<OneVector []>]>]>}} : (!qwerty<func(!qwerty<qbundle[3]>) rev-> !qwerty<qbundle[3]>>) -> !qwerty<func(!qwerty<qbundle[4]>) rev-> !qwerty<qbundle[4]>>
...
//  CHECK-NEXT:     %3 = qwerty.func_pred %arg1 by {list:{<UniformVectorSuperpos [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<VectorTilt tilt 2.700000e+02 : f64 [#qwerty.vectree<OneVector []>]>]>}} : (!qwerty<func(!qwerty<qbundle[2]>) rev-> !qwerty<qbundle[2]>>) -> !qwerty<func(!qwerty<qbundle[3]>) rev-> !qwerty<qbundle[3]>>
...
qwerty.func @return_semi_pointless_pred[](%arg0: !qwerty<func(!qwerty<qbundle[2]>) rev-> !qwerty<qbundle[2]>>) irrev-> !qwerty<func(!qwerty<qbundle[4]>) rev-> !qwerty<qbundle[4]>> {
  %0 = qwerty.func_pred %arg0 by {list:{<UniformVectorSuperpos [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<VectorTilt tilt 2.700000e+02 : f64 [#qwerty.vectree<OneVector []>]>]>}, std:X[1]} : (!qwerty<func(!qwerty<qbundle[2]>) rev-> !qwerty<qbundle[2]>>) -> !qwerty<func(!qwerty<qbundle[4]>) rev-> !qwerty<qbundle[4]>>
  qwerty.return %0 : !qwerty<func(!qwerty<qbundle[4]>) rev-> !qwerty<qbundle[4]>>
}
...
qwerty.func @call_semi_pointless_pred[](%arg0: !qwerty<qbundle[6]>) rev-> !qwerty<qbundle[6]> {
  %0 = qwerty.call pred {list:{<VectorTensor [#qwerty.vectree<UniformVectorSuperpos [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<OneVector []>]>, #qwerty.vectree<UniformVectorSuperpos [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<VectorTilt tilt 1.800000e+02 : f64 [#qwerty.vectree<OneVector []>]>]>]>}, std:X[2]} @trivial(%arg0) : (!qwerty<qbundle[6]>) -> !qwerty<qbundle[6]>
...
//  CHECK-NEXT:     %1 = qwerty.call adj pred {list:{<VectorTensor [#qwerty.vectree<UniformVectorSuperpos [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<VectorTilt tilt 2.700000e+02 : f64 [#qwerty.vectree<OneVector []>]>]>, #qwerty.vectree<UniformVectorSuperpos [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<VectorTilt tilt 2.700000e+02 : f64 [#qwerty.vectree<OneVector []>]>]>, #qwerty.vectree<UniformVectorSuperpos [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<VectorTilt tilt 2.700000e+02 : f64 [#qwerty.vectree<OneVector []>]>]>]>}} @trivial(%arg1) : (!qwerty<qbundle[5]>) -> !qwerty<qbundle[5]>
//  CHECK-NEXT:     scf.yield %1 : !qwerty<qbundle[5]>
//  CHECK-NEXT:   } else {
//  CHECK-NEXT:     %1 = qwerty.call adj pred {list:{<VectorTensor [#qwerty.vectree<UniformVectorSuperpos [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<VectorTilt tilt 2.700000e+02 : f64 [#qwerty.vectree<OneVector []>]>]>, #qwerty.vectree<UniformVectorSuperpos [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<VectorTilt tilt 2.700000e+02 : f64 [#qwerty.vectree<OneVector []>]>]>, #qwerty.vectree<UniformVectorSuperpos [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<VectorTilt tilt 2.700000e+02 : f64 [#qwerty.vectree<OneVector []>]>]>]>}} @id(%arg1) : (!qwerty<qbundle[5]>) -> !qwerty<qbundle[5]>
//  CHECK-NEXT:     scf.yield %1 : !qwerty<qbundle[5]>
//  CHECK-NEXT:   }
...
qwerty.func @pred_adj_call_if_const[](%arg0: i1, %arg1: !qwerty<qbundle[5]>) irrev-> !qwerty<qbundle[5]> {
  ...
  %1 = qwerty.func_adj %0 : (!qwerty<func(!qwerty<qbundle[2]>) rev-> !qwerty<qbundle[2]>>) -> !qwerty<func(!qwerty<qbundle[2]>) rev-> !qwerty<qbundle[2]>>
  %2 = qwerty.func_pred %1 by {list:{<VectorTensor [#qwerty.vectree<UniformVectorSuperpos [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<VectorTilt tilt 2.700000e+02 : f64 [#qwerty.vectree<OneVector []>]>]>, #qwerty.vectree<UniformVectorSuperpos [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<VectorTilt tilt 2.700000e+02 : f64 [#qwerty.vectree<OneVector []>]>]>, #qwerty.vectree<UniformVectorSuperpos [#qwerty.vectree<ZeroVector []>, #qwerty.vectree<VectorTilt tilt 2.700000e+02 : f64 [#qwerty.vectree<OneVector []>]>]>]>}} : (!qwerty<func(!qwerty<qbundle[2]>) rev-> !qwerty<qbundle[2]>>) -> !qwerty<func(!qwerty<qbundle[5]>) rev-> !qwerty<qbundle[5]>>
