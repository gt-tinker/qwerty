...
qwerty::FuncOp synthXor(mlir::RewriterBase &rewriter,
    ...
    qwerty::FuncOp new_func = qwerty::FuncOp::create(
        rewriter, loc, embed_func_name, func_ty);
    new_func.setPrivate();
...
qwerty::FuncOp synthInPlace(
    ...
    mlir::ValueRange inv = qwerty::CallOp::create(rewriter, loc, rev_xor_func, swapped_repacked).getResults();
